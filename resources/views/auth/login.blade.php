                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="form-login user" method="POST" action="/login">
                                        ...
                                        <button type="submit" class="btn btn-warning btn-user btn-block rounded-lg">
                                            Masuk
                                        </button>
                                        {{-- <hr> --}}
                                    ...
                                    {{-- <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html" style="color: rgb(153,0,255);">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="register.html" style="color: rgb(153,0,255);">Create an Account!</a>
                                    </div> --}}
                            </div>
                        </div>
                    </div>
