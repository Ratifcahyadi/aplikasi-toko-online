    ...
    <div class="p-3 text-center bg-light border-bottom sticky-top">
        <div class="container-fluid">
            <nav class="navbar navbar-expand navbar-light justify-content-between">
                <div class="row">
                    <!-- Sidebar - Brand -->
                    <a class="no-underline sidebar-brand d-flex align-items-center justify-content-center"
                        href="/">
                ...
                <div class="row">
                    <div class="d-flex float-end">
                        <a href="/checkout"
                            class="me-1 border rounded py-1 px-3 nav-link d-flex align-items-center mr-2"
                            target="_blank"> <i class="text-danger fas fa-heart m-1 me-md-2"></i>
                            <p class="d-none d-md-block mb-0">Wishlist</p>
                        </a>
                        <a href="/cart" class="border rounded py-1 px-3 nav-link d-flex align-items-center mr-2"
                            target="_blank"> <i class="text-warning fas fa-shopping-cart m-1 me-md-2"></i>
                            <p class="d-none d-md-block mb-0">My cart</p>
                        </a>
                        @if (Auth::guard('webmember')->check())
                            <a href="/profile"
                                class="bg-success rounded-pill text-white me-1 border rounded py-1 px-3 nav-link d-flex align-items-center ml-5 mr-2">
                                <p class="d-none d-md-block mb-0"> {{ Auth::guard('webmember')->user()->nama_member }}
                                </p>
                            </a>
                        @else
                            <a href="/login_member"
                                class="me-1 border rounded py-1 px-3 nav-link d-flex align-items-center"> <i
                                    class="text-dark fas fa-user-alt m-1 me-md-2"></i>
                                <p class="d-none d-md-block mb-0">Login</p>
                            </a>
                        @endif
                        @if (Auth::guard('webmember')->check())
                        <a href="/logout_member"
                            class="border-success border rounded-pill text-success me-1 border rounded py-1 px-3 nav-link d-flex align-items-center">
            ...
            <!-- Navbar -->
            <nav class="navbar navbar-expand navbar-light rounded justify-content-between navbar-responsive"
                style="background-color: #e9e3fd;">
                <!-- Container wrapper -->
                <!-- Toggle button -->
                {{-- <button
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-sm-12 col-lg-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button class="btn btn-info rounded-right border shadow-0" type="button"
