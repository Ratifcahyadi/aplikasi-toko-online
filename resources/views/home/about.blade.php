...
<header>
    ...
    <div class="container">
            ...
            <div class="col-md-6 gx-5 mb-4">
                <div class="logo-container">
                    <div class="logo-wrap">
                        ...
                        <img class="logo-dark2 img-fluid" src="/uploads/{{ $about->logo }}" alt="logo">
                    </div>
                </div>
            </div>
            <div class="col-md-6 gx-5 mb-4">
        ...
        <hr class="my-5" />
        <div class="text-center text-primary">TESTIMONI</div>
        @foreach ($testimonies as $testimony)
            <div class="item">
                <div class="testimonial">
                    <p class="testimonial-text h3">{{ $testimony->deskripsi }}</p>
                    <span class="text-warning">{{ $testimony->nama_testimoni }}</span>
                </div>
            </div>
        @endforeach
